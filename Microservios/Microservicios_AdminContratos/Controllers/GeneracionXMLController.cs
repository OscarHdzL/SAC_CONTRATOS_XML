...
namespace Servicios_AdminitracionContratos.Controllers
{
    ...
    public class GeneracionXMLController : ControllerBase
    {
        ...
        private GenerarXML_CFDI Negocio = new GenerarXML_CFDI();

        [HttpPost("Generar")]
        public IActionResult GenerarXML( [FromBody] DatosXml datos_facturacion_general)
        {
                ...
                //{
                //    xmlSerialize.Serialize(stringWriter, objCompXSD);
        ...
        public IActionResult PrevisualizarXML([FromBody] DatosXml datos_facturacion_general)
        {
