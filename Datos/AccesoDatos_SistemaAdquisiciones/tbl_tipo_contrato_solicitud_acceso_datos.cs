...
{
    public class tbl_tipo_contrato_solicitud_acceso_datos
    {
        public BDParametros GeneracionParametros = new BDParametros();
        public IConfiguration Configuration = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: false).Build();
        string StoreProcedure = "sp_get_tipocontratosolicitud_instancia_dropdown";
        ...
        public ResponseGeneric<List<Crudresponse>> AddSolicitud(sp_solicitud_en solicitud)
        {
            try
            {
                #region Parametros
