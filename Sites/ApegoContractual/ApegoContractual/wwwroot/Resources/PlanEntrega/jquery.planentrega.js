...
//-----------------------------------------------------
/////INSTANCIAS 
//var PlanEntregaCompletoClass = {
//    PlanEntrega: null,
//    PlanEntregaDetalle: null
//}

//var PlanEntregaClass = {
//    id: null,
//    tblent_contrato_id: null, //id de contrato 
//    tbl_RespApego_Contrato_ac_id: null, // Id del responsable de cumplimiento
//    tbl_ubicaciones_ac_id: null, // id ubicacion 
//    tbl_link_ubicaciones_id: null, // id ejecutor 
//    tbl_ProdServ_ac_id: null, // id producto 
//    Inclusion: null, //
//    tbl_PlanEntregaDetalle_ac_id: null, //id de plan de entrega
//    Estatus: null, // 
//    Cantidad: null, // 
...
//var objetoProductoClass = {
//    id: null,
//    Cantidad: null,
//    Nombre: null
//}

//var objetoUbicacionClass = {
//    id: null,
//    idUbicacion: null,
//    idResponsable: null,
//    productos: null,
...
function getDropProductos_PE() {
    ...
    $.get($("#EndPointAC").val() + "ProdServ/List/Contrato/" + idContrato, function (data, status) {
        JSON_Productos = data;
        console.log('productos del contrato');
        console.log(data);
...
$('#DropProductos').change(function () {
    ...
    for (var i = 0; i <= JSON_Productos.length - 1; i++) {
        ...
        var idproductos = $('#DropProductos').val();
...
$('#btnGuardarPlanEntrega').click(function () {
    ...
    if (Validacion.Bit) {
        ...
        objHeaderPlan.p_id = idPlanEntrega; //Se obtiene de la variable global 
        ...
        $.ajax({
            ...
            processData: false,
            type: 'POST',
            url: $("#EndPointAC").val() + "Operaciones/PE/add"
...
$('#AgregarProducto').click(function () {
    ...
    if (Validacion.Bit) {
        ...
        console.log(CadenaJSON_Producto);
        t.row.add([
            CadenaJSON_Producto,
            nombreProducto,
            cantidadProducto,
...
function ModalAgregarProducto(idUbicacion, idEjecutor, IdElemento, Ubicacion) {
    ...
    if (JSON_Productos.length != undefined) {
        ...
        for (var i = 0; i <= JSON_Productos.length - 1; i++) {
            ...
            Interno.push($('#DropProductosGlobal').dropdown().find('option[value="' + JSON_Productos[i].productos[0].p_tbl_contrato_producto_id + '"]').text()); //Nombre del Producto
            Interno.push(JSON_Productos[i].productos[0].p_cantidad);
            ...
            Interno.push(JSON_Productos[i].productos[0].p_tbl_contrato_producto_id);///Se llena el id del producto
